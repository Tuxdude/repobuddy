# -*- coding: utf-8 -*-
#
# RepoBuddy documentation build configuration file, created by
...
htmlhelp_basename = 'RepoBuddydoc'
...
latex_documents = [
  ('index', 'RepoBuddy.tex', u'RepoBuddy Documentation',
   u'Ash \\textless{}tuxdude.github@gmail.com\\textgreater{}', 'manual'),
]
...
man_pages = [
    ('index', 'repobuddy', u'RepoBuddy Documentation',
     [u'Ash <tuxdude.github@gmail.com>'], 1)
]
...
texinfo_documents = [
  ('index', 'RepoBuddy', u'RepoBuddy Documentation',
   u'Ash <tuxdude.github@gmail.com>', 'RepoBuddy', 'One line description of project.',
   'Miscellaneous'),
]
